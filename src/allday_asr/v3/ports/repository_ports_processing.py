...
class EvidenceProjectionRepository(Protocol):
    def record_annotation_facts(self, before, evidence, dimensions, actor, created_at) -> tuple[dict, list[str]]: ...
    def annotation_projection_evidence(self, utterance) -> dict: ...
    def annotation_is_current(self, utterance, dimension: str) -> bool: ...
