...
> 文档状态：V3.0 实施基线（V3.0-A、V3.0-B 于 2026-08-31 完成；V3.0-C 工程实现完成、真机验收待执行；V3.0-D、V3.0-E 工程实现完成；V3.0-F 工程实现完成、真机验收待执行）
...
8. V3.0-G 通过前，V2 CLI 和 V2 数据库保持可独立回退。
...
6. V3 默认入口不调用旧未版本化页面 API；Legacy 入口仍可只读回退。
